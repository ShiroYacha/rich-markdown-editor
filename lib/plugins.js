...
var createPlugins = function createPlugins(_ref) {
  var getLinkComponent = _ref.getLinkComponent;
  ...
  return [(0, _slatePasteLinkify2.default)({
    ...
    insertImage: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(change, file, editor) {
  ...
  }), (0, _slateCollapseOnEscape2.default)({ toEdge: "end" }), (0, _KeyboardShortcuts2.default)(), (0, _MarkdownShortcuts2.default)(), (0, _MarkdownPaste2.default)(), (0, _Ellipsis2.default)(), (0, _slateTrailingBlock2.default)({ type: "paragraph" }), (0, _Embeds2.default)({ getComponent: getLinkComponent })];
};
