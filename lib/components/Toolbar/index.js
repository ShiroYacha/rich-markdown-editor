...
var Toolbar = function (_React$Component) {
  ...
  function Toolbar() {
    ...
    }, _this.debouncedUpdate = (0, _debounce3.default)(function () {
      _this.update();
    }, 200), _this.update = function () {
...
})(["padding:8px 16px;position:absolute;z-index:200;top:-10000px;left:-10000px;opacity:0;background-color:", ";border-radius:4px;transform:scale(0.95);transition:opacity 150ms cubic-bezier(0.175,0.885,0.32,1.275),transform 150ms cubic-bezier(0.175,0.885,0.32,1.275);transition-delay:250ms;line-height:0;height:40px;box-sizing:border-box;pointer-events:none;*{box-sizing:border-box;}", ";@media print{display:none;}"], function (props) {
