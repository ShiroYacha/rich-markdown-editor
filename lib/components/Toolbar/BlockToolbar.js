...
var BlockToolbar = (_dec = (0, _reactKeydown2.default)("esc"), (_class = function (_React$Component) {
  ...
  function BlockToolbar() {
    ...
    }, _this.renderPluginBlockButton = function (type, displayType, dataCallback, customTriggerCallback, iconCallback, key) {
      var hiddenToolbarButtons = _this.props.theme.hiddenToolbarButtons;
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        _extends({}, attributes, { ref: function ref(_ref4) {
            return _this4.bar = _ref4;
          } }),
        React.createElement(HiddenInput, {
          type: "file",
          ref: function ref(_ref3) {
            return _this4.file = _ref3;
          },
        ...
        blockToolbarPlugins && blockToolbarPlugins.map(function (p, index) {
          return p.isSeparator ? React.createElement(Separator, null) : _this4.renderPluginBlockButton(p.type, p.displayType, p.dataCallback, p.customTriggerCallback, p.icon, index);
        })
      );
    }
  }]);
