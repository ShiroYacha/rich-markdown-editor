...
})(["position:absolute;top:0;right:0;opacity:0;transition:opacity 50ms ease-in-out;z-index:1;font-size:12px;color:", ";background:", ";border-radius:0 4px 0 4px;padding:1px 8px;cursor:pointer;"], function (props) {
