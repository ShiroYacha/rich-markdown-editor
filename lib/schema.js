...
var schema = {
  ...
  document: {
    nodes: [{
      types: ["paragraph", "heading1", "heading2", "heading3", "heading4", "heading5", "heading6", "block-quote", "code", "horizontal-rule", "image", "bulleted-list", "ordered-list", "todo-list", "block-toolbar", "table", "richcontrol"],
      min: 1
    }]
  }
};
