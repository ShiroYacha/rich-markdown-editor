...
function renderNode(props, blockToolbarPlugins) {
  var attributes = props.attributes;

  var propsWithPlugins = _extends({}, props, { blockToolbarPlugins: blockToolbarPlugins });
  switch (props.node.type) {
    case "paragraph":
      return React.createElement(_Paragraph2.default, props);
    case "block-toolbar":
      return React.createElement(_BlockToolbar2.default, propsWithPlugins);
    case "block-quote":
